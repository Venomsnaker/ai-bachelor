...
def set_args():
    ...
    parser.add_argument('--model_variant', type=str, default="bert-base-uncased-quad")
    parser.add_argument('--save_file', type=str, default="data/exports/result_mvclip_ver0.8.json", help='save result path')
...
def main():
    ...
    test_data = MyDataset(mode='private_test', text_name=args.text_name, limit=None)
